package com.github.frcsty.discordminecrafthook.data.cache;

import com.github.frcsty.discordminecrafthook.data.cache.listener.RequestRemovalListener;
...
public final class RequestCache {
    ...
    public RequestCache() {
        this.requestCache = CacheBuilder.newBuilder()
                ...
                .maximumSize(500)
                .removalListener(new RequestRemovalListener())
                .build();
    }
     ...
     */
    public void addCodeToCache(@NotNull final String code, @NotNull final UUID playerIdentifier) {
     ...
     */
    @Nullable
    public UUID getUUIDAssociatedTo(@NotNull final String code) {
     ...
     */
    public void invalidateCode(@NotNull final String code) {
